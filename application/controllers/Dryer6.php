...
class Dryer6 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('dryer6/index', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }

    public function tambah()
    {
        $data['title'] = 'Tambah Dryer6';
        $data['script'] = 'dryer6/script';
        ...
        $this->load->view('_layout_sifa/sidebar', $data);
        $this->load->view('_layout_sifa/topbar', $data);
        $this->load->view('dryer6/tambah', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }
    ...
    public function store(){
        ...
        $simpan = $this->db->insert('dryer6', $data_to_save);
        if($simpan){
    ...
    public function remove($id){
        $hapus = $this->db->delete('dryer6', array('id' => $id));
        if($hapus){
    ...
    {
        $query = $this->db->get_where('dryer6', array('id' => $id));
        $data['title'] = 'Edit Dryer6';
        $data['script'] = 'dryer6/script';
        $data['row'] = $query;
        $this->load->view('_layout_sifa/header', $data);
        $this->load->view('_layout_sifa/sidebar', $data);
        $this->load->view('_layout_sifa/topbar', $data);
        $this->load->view('dryer6/edit', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }
    ...
    public function update(){
        ...
        $simpan = $this->db->update('dryer6', $data_to_save, array('id' => $id));
        if($simpan){
