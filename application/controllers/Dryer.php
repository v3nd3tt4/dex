...
class Dryer extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('dryer/index', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }

    public function tambah()
    {
        $data['title'] = 'Tambah Dryer';
        $data['script'] = 'dryer/script';
        ...
        $this->load->view('_layout_sifa/sidebar', $data);
        $this->load->view('_layout_sifa/topbar', $data);
        $this->load->view('dryer/tambah', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }
    ...
    public function store(){
        ...
        $simpan = $this->db->insert('dryer', $data_to_save);
        if($simpan){
    ...
    public function remove($id){
        $hapus = $this->db->delete('dryer', array('id' => $id));
        if($hapus){
    ...
    {
        $query = $this->db->get_where('dryer', array('id' => $id));
        $data['title'] = 'Edit Dryer';
        $data['script'] = 'dryer/script';
        $data['row'] = $query;
        $this->load->view('_layout_sifa/header', $data);
        $this->load->view('_layout_sifa/sidebar', $data);
        $this->load->view('_layout_sifa/topbar', $data);
        $this->load->view('dryer/edit', $data);
        $this->load->view('_layout_sifa/footer', $data);
    }
    ...
    public function update(){
        ...
        $simpan = $this->db->update('dryer', $data_to_save, array('id' => $id));
        if($simpan){
