...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="row mb-3">
        ...
        <div class="col-xl-12 col-md-12 mb-4">
            <div class="card h-100">
                <div class="card-body">
                    <a href="<?=base_url()?>pv2/pv2_tegangan/tambah" class="btn btn-outline-success mb-1 float-right"><i class="fas fa-plus"></i> Tambah</a>
                    <br><br><br>
                    <form method="POST" action="<?=base_url()?>pv2/pv2_tegangan">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php }else{?>
                                <a href="<?=base_url()?>pv2/pv2_tegangan" class="btn btn-danger">Reset</a>
                                <?php }?>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="table table-bordered table-striped table-hover dataTables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="<?=base_url()?>pv2/pv2_tegangan/edit/<?=$row_data->id?>" class="btn btn-outline-info btn-sm mb-1 " onclick="return confirm('Apakah anda yakin akan mengedit data ini?');"><i class="fas fa-edit"></i> Edit</a>
                                </td>
                            </tr>
                            <?php }?>
                        </tbody>
